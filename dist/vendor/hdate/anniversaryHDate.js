...
import { getBirthdayHD, getYahrzeitHD } from './anniversary.js';
 ...
 */
export function yahrzeit(hyear, date) {
 ...
 */
export function birthdayOrAnniversary(hyear, date) {
    const hd = getBirthdayHD(hyear, date);
    return hd && new HDate(hd);
}
//# sourceMappingURL=anniversaryHDate.js.map